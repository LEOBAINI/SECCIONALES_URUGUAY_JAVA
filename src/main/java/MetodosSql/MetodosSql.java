...
public class MetodosSql extends Conexion {
    ...
    public int insertarOmodif(String sentenciaSql) {
    	logger.info("Ejecutando :"+sentenciaSql);
        System.out.println(sentenciaSql);
        //System.out.println("Luego borrar este syso, solo es para mostrar los datos enviados a la base, (metodosSql linea 34 y 35)");
        int status=0;
        Conexion con = new Conexion();
        ...
        try {
            ...
            con.desconectar();
            status=1;
            logger.info("Ejecutado correctamente: "+sentenciaSql);
 
        } catch (SQLException e) {
        	logger.error("Error en insertarOmodificar :"+sentenciaSql+" "+e.getMessage());
            System.out.println("Error en insertarOmodificar :"+sentenciaSql);
            System.out.println(e.getMessage());
	...
	public void insertarOmodifClientes(ArrayList<Cliente> clientes) {
        ...
        try {
            ...
            for(int i=0;i<clientes.size();i++) {
            	queryUpdate=clientes.get(i).getQueryUpdate();
            	 logger.info("Ejecutando :"+queryUpdate);
            	  con.statemente.executeUpdate(queryUpdate);
            ...
            logger.info("Ejecutado correctamente: "+queryUpdate);
 
        } catch (SQLException e) {
        	logger.error("Error en insertarOmodificar :"+queryUpdate+" "+e.getMessage());
            System.out.println("Error en insertarOmodificar :"+queryUpdate);
            System.out.println(e.getMessage());
